...
input_folder = "/path/to/input_folder"  # Replace with the path to your input folder
output_folder = "/path/to/output_folder"  # Replace with the path to your output folder
log_folder = "/path/to/logs_folder"  # Subfolder to store log files
